...
namespace PatchManagement.Persistence.Migrations
{
    ...
    [Migration("20260826143238_AssetSourceVocabulary")]
    partial class AssetSourceVocabulary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.Asset", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Ip", "EndpointPort")
                        .IsUnique()
                    ...
                    b.ToTable("assets", null, t =>
                        {
                            t.HasCheckConstraint("ck_assets_source", "source IN ('discovery', 'ad', 'dhcp', 'inventory')");
                        });
                });

            modelBuilder.Entity("PatchManagement.Persistence.Entities.AssetEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_asset_evidence");

                    b.HasIndex("TenantId", "AssetId")
                        .HasDatabaseName("ix_asset_evidence_tenant_id_asset_id");

                    b.HasIndex("TenantId", "DiscoveryRunId")
                        .HasDatabaseName("ix_asset_evidence_tenant_id_discovery_run_id");

                    b.HasIndex("TenantId", "Source", "Present")
                        .HasDatabaseName("ix_asset_evidence_tenant_id_source_present");

                    b.ToTable("asset_evidence", null, t =>
                        {
                            t.HasCheckConstraint("ck_asset_evidence_discovery_names_its_run", "(source = 'discovery') = (discovery_run_id IS NOT NULL)");

                            t.HasCheckConstraint("ck_asset_evidence_source", "source IN ('discovery', 'ad', 'dhcp', 'inventory')");
                        });
                });
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.DiscoveryRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("RefusedRanges")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("refused_ranges");

                    b.Property<string>("RequestedPorts")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("requested_ports");

                    b.Property<string>("RequestedRanges")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("requested_ranges");
                    ...
                    b.HasAlternateKey("TenantId", "Id")
                        .HasName("ak_discovery_runs_tenant_id_id");

                    b.HasIndex("TenantId", "StartedAt")
                        .HasDatabaseName("ix_discovery_runs_tenant_id_started_at");

                    b.ToTable("discovery_runs", null, t =>
                        {
                            t.HasCheckConstraint("ck_discovery_runs_completion", "(outcome = 'running') = (completed_at IS NULL)");

                            t.HasCheckConstraint("ck_discovery_runs_outcome", "outcome IN ('running', 'ok', 'refused-by-policy', 'invalid-range', 'failed')");

                            t.HasCheckConstraint("ck_discovery_runs_refusal_probed_nothing", "outcome NOT IN ('refused-by-policy', 'invalid-range') OR addresses_probed = 0");
                        });
                });
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.HostKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_host_keys");

                    b.HasIndex("TenantId", "AssetId")
                        .HasDatabaseName("ix_host_keys_tenant_id_asset_id");

                    b.HasIndex("TenantId", "FingerprintSha256")
                        .HasDatabaseName("ix_host_keys_tenant_id_fingerprint_sha256");
                    ...
                    b.ToTable("host_keys", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_host_keys_status", "status IN ('trusted', 'pending', 'superseded', 'revoked')");

                            t.HasCheckConstraint("ck_host_keys_superseded_at", "(status IN ('superseded', 'revoked')) = (superseded_at IS NOT NULL)");

                            t.HasCheckConstraint("ck_host_keys_verified_after_first_seen", "last_verified_at >= first_seen_at");
                        });
                });
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.AssetEvidence", b =>
                {
                    b.HasOne("PatchManagement.Persistence.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_asset_evidence_tenants_tenant_id");
                    ...
                    b.HasOne("PatchManagement.Persistence.Entities.Asset", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_asset_evidence_assets_tenant_id_asset_id");

                    b.HasOne("PatchManagement.Persistence.Entities.DiscoveryRun", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "DiscoveryRunId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_asset_evidence_discovery_runs_tenant_id_discovery_run_id");
                });
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.DiscoveryRun", b =>
                {
                    b.HasOne("PatchManagement.Persistence.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_discovery_runs_tenants_tenant_id");
                });
            ...
            modelBuilder.Entity("PatchManagement.Persistence.Entities.HostKey", b =>
                {
                    b.HasOne("PatchManagement.Persistence.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_host_keys_tenants_tenant_id");
                    ...
                    b.HasOne("PatchManagement.Persistence.Entities.Asset", null)
                        ...
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_host_keys_assets_tenant_id_asset_id");
                });
